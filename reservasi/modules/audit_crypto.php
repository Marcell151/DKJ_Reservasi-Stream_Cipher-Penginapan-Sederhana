...
<?php else: ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="card border-t-4 border-indigo-600 lg:col-span-1 space-y-6">
            ...
            <div class="pt-4 border-t border-gray-100">
                <label class="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2 block">Hasil Akhir (Plaintext IP)</label>
                <div class="bg-emerald-50 border border-emerald-100 rounded-xl p-4 flex items-center gap-3">
                    ...
                    <div>
                        <div class="font-bold text-emerald-700 text-lg font-mono"><?= htmlspecialchars($ip_asli) ?></div>
