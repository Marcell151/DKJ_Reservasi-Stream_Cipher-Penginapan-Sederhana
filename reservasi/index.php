...
<head>
    ...
    <title>Login - DKJ Reservasi</title>
        ...
        <div class="bg-white rounded-[2rem] p-10 shadow-2xl relative overflow-hidden">
            ...
            <div class="relative z-10">
                <div class="flex flex-col items-center mb-10">
                    ...
                    <h1 class="text-2xl font-bold text-gray-900">Sistem Reservasi</h1>
                    <p class="text-gray-500 text-sm mt-2">Penginapan Sederhana ChaCha20</p>
                </div>
