...
<head>
    ...
    <title>Dashboard - DKJ Rental Kendaraan</title>
    <!-- Tailwind CSS -->
    ...
    <div class="flex">
        ...
        <aside class="sidebar h-screen fixed">
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="?page=vehicles" class="<?= is_active('vehicles', $page) ?>">
                        <i data-lucide="car" class="w-5 h-5"></i> Data Kendaraan
                    </a>
                </li>
                <li>
                    <a href="?page=customers" class="<?= is_active('customers', $page) ?>">
                        <i data-lucide="users" class="w-5 h-5"></i> Data Pelanggan
                    </a>
                </li>
                <li>
                    <a href="?page=rentals" class="<?= is_active('rentals', $page) ?>">
                        <i data-lucide="repeat" class="w-5 h-5"></i> Transaksi Rental
                    </a>
                </li>
                <li>
                    <a href="?page=returns" class="<?= is_active('returns', $page) ?>">
                        <i data-lucide="check-square" class="w-5 h-5"></i> Pengembalian
                    </a>
                </li>
                <li>
            ...
            <header class="flex justify-between items-center mb-8">
                <div>
                    ...
                    <p class="text-gray-500 text-sm mt-1">
                        Selamat datang di sistem manajemen rental kendaraan
                    </p>
                </div>
