...
$raw_customers = $db->query("SELECT * FROM customers ORDER BY id DESC LIMIT 10")->fetchAll(PDO::FETCH_ASSOC);
?>
                ...
                <table class="w-full text-left text-[9px] font-mono">
                    <thead class="bg-white/5 text-gray-500 uppercase">
                        <tr>
                            ...
                            <th class="p-3 border-b border-white/10">nama_pelanggan</th>
                            <th class="p-3 border-b border-white/10 text-red-400">nomor_hp (ENC)</th>
                            <th class="p-3 border-b border-white/10 text-red-400">email (ENC)</th>
                            <th class="p-3 border-b border-white/10 text-red-400">alamat (ENC)</th>
                            <th class="p-3 border-b border-white/10 text-indigo-400">encrypted_ip_seed</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-white/5">
                        <?php foreach ($raw_customers as $row): ?>
                        <tr class="hover:bg-white/5 transition-colors">
                            <td class="p-3 text-gray-500"><?= $row['id'] ?></td>
                            <td class="p-3 text-gray-300"><?= htmlspecialchars($row['nama_pelanggan']) ?></td>
                            <td class="p-3 text-red-400 break-all"><?= $row['nomor_hp'] ?></td>
                            <td class="p-3 text-red-400 break-all"><?= $row['email'] ?></td>
                            <td class="p-3 text-red-400 break-all"><?= $row['alamat'] ?></td>
